...
/* Generated from ../O.Common/vacuumSim.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devvacuumSimVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devvacuumSimVersion", "devLsoSoft", "devLsoSoftCallback",
...
int vacuumSim_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/user/vacuumSim";
...
/* vacuumSim_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: vacuumSim_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(vacuumSim_registerRecordDeviceDriver(*iocshPpdbbase));
}
