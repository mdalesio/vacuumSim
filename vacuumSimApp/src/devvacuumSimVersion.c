...
#include "vacuumSimVersion.h"

/* must be last include */
#include "epicsExport.h"

const char version[] = vacuumSimVERSION;
...
static lsidset devvacuumSimVersion = {
    5, NULL, NULL, NULL, NULL, read_string
};
epicsExportAddress(dset,devvacuumSimVersion);
